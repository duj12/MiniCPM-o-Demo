...
**单轮视频并发测试（121.mp4, 9.6MB, turn_based, Q4_K_M）：**

| 并发路数 | 通过 | 推理耗时 | 输出字符 | 生成速度 | 峰值 VRAM | GPU 利用率 |
|:-------:|:---:|:--------:|:--------:|:--------:|:---------:|:---------:|
| 1 | ✅ | 4,015ms | 321 | 80 ch/s | 10,901 MiB | 93% |
| 2 | ✅ | 3,302-3,778ms | 173-267 | 52-71 ch/s | 12,701 MiB | 94% |
| 3 | ✅ | 3,131-4,234ms | 166-396 | 53-94 ch/s | 14,511 MiB | 96% |
| **4** | **✅** | **3,147-4,780ms** | **123-355** | **39-82 ch/s** | **14,513 MiB** | **99%** |
